...
# dataframe path and read file
df = pd.read_csv(r'D:\pythonProject\BH Data Processing\AGS File (Read)\GEOLcomb.csv')
df.drop_duplicates()

# remove blank row with coordination, GL and final depth
...
# rock: granite, basalt, granodiorite, rhyolite, tuff
...
# QUARTZ ROCKS, OTHER ROCKS, MUG/ORGANICS
...
# fill na with blank for the rest
...
#cols = cols[16] + cols[8] + cols[:8] + cols[9:16] + cols[17:]
