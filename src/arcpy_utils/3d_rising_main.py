...
def RisingMain(feature):
    ...
    arcpy.management.AddField(Risingmain_name, 'OBJECTID', 'LONG')
    arcpy.management.AddField(Risingmain_name, 'WIDTH', 'LONG')
    arcpy.management.AddField(Risingmain_name, 'HEIGHT', 'LONG')
    ...
    i = 0
    cur_update = arcpy.da.UpdateCursor(Risingmain_name,['OBJECTID', 'HEIGHT', 'WIDTH', 'FEAT_NUM', 'SHAPE_1', 'US_IL', 'DS_IL'])
